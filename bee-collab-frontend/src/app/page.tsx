    ...
    <div className={styles.lightThemeContainer}>
      <header className={styles.header}>
        ...
        <div className={styles.headerRight}>
          ...
          <div className={styles.avatar} onClick={() => router.push(isLoggedIn ? '/workspace' : '/login')} title={isLoggedIn ? "Go to Workspace" : "Sign in"}>
            B
          </div>
        </div>
      </header>
          ...
          {isCreating ? (
            ...
            <div className={styles.actionArea}>
              <button 
                ...
                style={hasActiveMeeting ? { opacity: 0.5, cursor: 'not-allowed' } : {}}
                title={hasActiveMeeting ? "Anda memiliki meeting aktif. Silakan masuk via Workspace atau akhiri terlebih dahulu." : "Buat meeting baru"}
              >
